<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Loan_apply.aspx.cs" Inherits="Loan_apply" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <h1 class="page-header">LOAN APPLY</h1>
    <div class="row">
     ...
     <p style="color: #3333CC"> <strong>RESIDENTAL ADDRESS OF FARMER</strong></p>
        ...
        <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="TextBox1"
        ValidationGroup="Group2" runat="server" ErrorMessage="Amount is required." style="color: #FF0000" />
								</div>
         ...
         <div class="col-lg-4">
          ...
          <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <label>Previous loan dues</label>
        ...
        ValidationGroup="Group2" runat="server" ErrorMessage="Account is required." style="color: #FF0000" />
								</div>
        ...
        <div class="form-group" style="text-align: center">
         ...
         <div class="col-lg-6">
             <div class="form-group">
                 <asp:Button ID="Button1" runat="server" Text="Apply" style="text-align: center" OnClientClick="return Validate()" OnClick="Button1_Click1" />
								</div>
