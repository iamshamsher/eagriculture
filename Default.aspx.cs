...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        string inscmd = "insert into reg(farmer_name, dob, uid_no, contact,gender,catogary,email,apl_bpl,address,date,password) values(@farmer_name, @dob, @uid_no, @contact,@gender,@catogary,@email,@apl_bpl,@address,@date,@password)";
        ...
        insertuser.Parameters.AddWithValue("@uid_no", TextBox3.Text);
        insertuser.Parameters.AddWithValue("@contact", TextBox4.Text);
        insertuser.Parameters.AddWithValue("@gender", gender);
         ...
         insertuser.Parameters.AddWithValue("@email", TextBox7.Text);
         insertuser.Parameters.AddWithValue("@apl_bpl", TextBox8.Text);
         insertuser.Parameters.AddWithValue("@address", TextBox9.Text);
         insertuser.Parameters.AddWithValue("@password", TextBox10.Text);
